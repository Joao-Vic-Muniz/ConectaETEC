import { Search, Code, Briefcase, Award, Zap, Globe, TrendingUp, Users, X, Plus } from "lucide-react";
...
const projects = [
  {
    ...
    category: "projetos",
    description: "Plataforma web para gerenciar alunos, professores e notas",
    members: 5,
    views: 1200,
  ...
  {
    id: 2,
    title: "App de Horários",
    category: "oportunidades",
    description: "Aplicativo mobile para visualizar horários de aula",
    members: 3,
    views: 890,
  ...
  },
  {
    ...
    category: "projetos",
    description: "Painel de análise de dados da escola",
    members: 4,
    views: 650,
  ...
  },
  {
    ...
    title: "Chatbot IA",
    category: "oportunidades",
    description: "Assistente inteligente para dúvidas escolares",
    members: 2,
    views: 1450,
  ...
  },
  {
    ...
    category: "oportunidades",
    description: "Oportunidade de estágio em empresa de tecnologia",
    members: 12,
    views: 3200,
  ...
  },
  {
    ...
    category: "cursos",
    description: "Aprenda React avançado com hooks e context API",
    members: 45,
    views: 5600,
  ...
  },
  {
    ...
    category: "cursos",
    description: "Domine ES6+ e práticas modernas de JS",
    members: 78,
    views: 8900,
  ...
  },
  {
    ...
    title: "AI/ML em 2025",
    category: "trending",
    description: "Tendências em Inteligência Artificial e Machine Learning",
    members: 156,
    views: 12400,
    tags: ["IA", "ML", "Python"],
  },
...
const stats = [
  ...
  { icon: Users, label: "Membros",      value: "890" },
  { icon: Award, label: "Cursos",       value: "24"  },
