  ...
  return (
    <div className="w-full font-quicksand bg-bg">
      ...
      >
        ...
        <div
          className="absolute bottom-20 right-10 w-80 h-80 bg-primary-light/3 blur-3xl rounded-full animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-accent/2 blur-3xl rounded-full animate-pulse"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-screen-2xl min-h-[50vh] md:min-h-[60vh] gap-8 md:gap-16 bg-primary-dark/20 backdrop-blur-3xl p-6 md:p-12 lg:p-16 rounded-[2rem] md:rounded-[2.5rem] shadow-[0_25px_100px_-15px_rgba(0,0,0,0.8)] border border-white/5 relative z-10">
          <div className="flex-1 z-10 space-y-6 md:space-y-8 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center md:justify-start">
              ...
              <a
                href="#comunidade"
                className="inline-block text-center bg-white/5 hover:bg-white/10 text-white border border-white/10 px-8 md:px-12 py-3 md:py-4 rounded-full font-fredoka text-base md:text-lg font-bold transition-all duration-300 cursor-pointer"
              >
                Saiba Mais
              </a>
            </div>
